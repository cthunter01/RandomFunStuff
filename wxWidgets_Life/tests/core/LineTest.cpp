...
// Checks everything a line from a to b must satisfy; returns the first problem, or "" if there is none.
...
{
    const CellPos ends[] = {{7, 3},   {3, 7},   {-3, 7}, {-7, 3}, {-7, -3}, {-3, -7}, {3, -7},  {7, -3},
                            {7, 0},   {0, 7},   {-7, 0}, {0, -7}, {7, 7},   {-7, 7},  {-7, -7}, {7, -7},
                            {100, 1}, {1, 100}, {5, 2},  {2, 5},  {-6, 4},  {4, -6}};
...
TEST(LineTest, RandomLines)
{
    ...
    for (int i = 0; i < 2000; ++i) {
        const CellPos a{coordinate(), coordinate()};
        const CellPos b{coordinate(), coordinate()};
